...
export const updateUserSchema = z.object({
  ...
  default_message_notifications: z.number().int().min(0).max(2).optional(),
  explicit_content_filter: z.number().int().min(0).max(2).optional(),
  allow_dms_from: z.enum(['everyone', 'friends', 'none']).optional(),
  allow_friend_requests_from: z.enum(['everyone', 'friends_of_friends', 'none']).optional(),
  streamer_mode_enabled: z.boolean().optional(),
  streamer_mode_auto_detect: z.boolean().optional(),
  streamer_mode_hide_links: z.boolean().optional(),
  streamer_mode_hide_email: z.boolean().optional(),
  streamer_mode_hide_notes: z.boolean().optional(),
  streamer_mode_hide_notifications: z.boolean().optional(),
  streamer_mode_hide_personal_info: z.boolean().optional(),
  streamer_mode_disable_sounds: z.boolean().optional(),
