...
import { messageSendRateLimit, messageEditDeleteRateLimit, reactionAddRateLimit, bulkDeleteRateLimit, searchRateLimit } from '../middleware/rate-limit.middleware.js';
...
router.post('/', authenticate, messageSendRateLimit, uploadAttachments, validate(createMessageSchema), messages.createMessage);
...
router.put('/:messageId/reactions/:emoji/@me', authenticate, reactionAddRateLimit, messages.addReaction);
