...
const PERMISSION_DEFS = [
  ...
  { bit: 0x40000000n, label: 'Gérer les émojis et autocollants', group: 'Général' },
  { bit: 0x20000000n, label: 'Gérer les webhooks', group: 'Général' },
  { bit: 0x1n, label: 'Créer une invitation', group: 'Général' },
  { bit: 0x80n, label: 'Voir le journal d\'audit', group: 'Général' },
  { bit: 0x4000000n, label: 'Changer son pseudo', group: 'Général' },
  { bit: 0x8000000n, label: 'Gérer les pseudonymes', group: 'Général' },
  { bit: 0x80000000n, label: 'Utiliser les commandes d\'application', group: 'Général' },
  { bit: 0x100000000n, label: 'Demander à parler', group: 'Général' },

  // Modération (bits 1-2, 13, 40)
  ...
  { bit: 0x10000000000n, label: 'Modérer des membres', group: 'Modération' },

  // Messagerie (bits 6, 11-12, 14-19, 34-38, 49, 51)
  ...
  { bit: 0x80000n, label: 'Voir les insights du serveur', group: 'Messagerie' },
  { bit: 0x400000000n, label: 'Gérer les fils', group: 'Messagerie' },
  { bit: 0x800000000n, label: 'Créer des fils publics', group: 'Messagerie' },
  { bit: 0x1000000000n, label: 'Créer des fils privés', group: 'Messagerie' },
  { bit: 0x2000000000n, label: 'Utiliser des autocollants externes', group: 'Messagerie' },
  { bit: 0x4000000000n, label: 'Envoyer dans les fils', group: 'Messagerie' },
  { bit: 0x2000000000000n, label: 'Envoyer des sondages', group: 'Messagerie' },
  { bit: 0x8000000000000n, label: 'Épingler des messages', group: 'Messagerie' },
  { bit: 0x10000000000000n, label: 'Contourner le mode lent', group: 'Messagerie' },

  // Vocal (bits 8-9, 20-25, 42, 46, 48)
  { bit: 0x100n, label: 'Priorité orateur', group: 'Vocal' },
  { bit: 0x200n, label: 'Streamer (Go Live)', group: 'Vocal' },
  { bit: 0x400n, label: 'Voir les canaux', group: 'Vocal' },
  ...
  { bit: 0x40000000000n, label: 'Utiliser le soundboard', group: 'Vocal' },
  { bit: 0x400000000000n, label: 'Messages vocaux', group: 'Vocal' },
  { bit: 0x1000000000000n, label: 'Statut salon vocal', group: 'Vocal' },

  // Avancé (bits 39, 41, 43-45, 50, 52)
  ...
  { bit: 0x100000000000n, label: 'Créer des événements', group: 'Avancé' },
...
const PERM_DESCRIPTIONS: Record<string, string> = {
  ...
  '4294967296': 'Permet de demander à parler dans un canal vocal (stage).',
  '2': 'Permet d\'expulser des membres du serveur.',
  '4': 'Permet de bannir définitivement des membres du serveur.',
  '8192': 'Permet de supprimer les messages des autres.',
  '1099511627776': 'Permet de rendre temporairement muet des membres (modération).',
  ...
  '524288': 'Permet de voir les insights du serveur (analytiques de base).',
  ...
  '16777216': 'Permet de déplacer des membres d\'un canal vocal à un autre.',
  '33554432': 'Permet d\'utiliser la détection vocale (VAD) dans un canal vocal.',
  ...
  '17592186044416': 'Permet de créer des événements planifiés, et modifier/supprimer ceux créés par l\'utilisateur.',
  '35184372088832': 'Permet d\'utiliser des sons de soundboard provenant d\'autres serveurs.',
  '70368744177664': 'Permet d\'envoyer des messages vocaux.',
  '281474976710656': 'Permet de définir le statut du canal vocal.',
  '562949953421312': 'Permet d\'envoyer des sondages.',
  '1125899906842624': 'Permet d\'utiliser les applications installées par l\'utilisateur.',
  '2251799813685248': 'Permet d\'épingler et désépingler des messages.',
  '4503599627370496': 'Permet de contourner les restrictions de slowmode.',
};
      ...
      <div className={styles.shell}>
        ...
        <div className={styles.content}>
          <div className={styles.contentInner}>
            ...
            {activeTab === 'webhooks' && <WebhookManager guildId={guild.id} channels={guild.channels || []} />}
